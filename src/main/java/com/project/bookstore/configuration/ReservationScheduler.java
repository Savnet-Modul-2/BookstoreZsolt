...
public class ReservationScheduler {
    ...
    public void reminderSetCancelledReservations() {
        List<Reservation> reservationList = reservationRepository.findByStartDateOlderThanAndStatus(LocalDate.now(), ReservationStatus.PENDING);
    ...
    public void reminderSetDelayedReservations() {
        List<Reservation> reservationList = reservationRepository.findByEndDateOlderThanAndStatus(LocalDate.now(), ReservationStatus.IN_PROGRESS);
