...
public class BookExemplarValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        if (target instanceof BookExemplarDto bookExemplarDto) {
        ...
        } else if (target instanceof BookExemplarsToCreateDto bookExemplarsToCreateDto) {
        ...
        } else if (target instanceof ReservationDto) {
            reservationValidator.validate(target, errors);
        }
    }
}
